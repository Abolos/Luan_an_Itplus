...
<%@ page import =" Thao_Tac_CSDL.categorys_management"%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="Categorys_Management.css">
</head>
<body>
<header>
        <nav>
    ...
    <div class="nav_left">
            ...
            <p style="background-color: #e5b589;"><a href="Categorys_Management.jsp">Categorys Management</a></p>
        ...
        <table>
            <tr>
                <td><h2>List</h2></td>
                <form method="post" action="search_category.jsp">
                    <td colspan="2">
                        <div class="search-container">
                    ...
                    <td class="export">
                        ...
                        <span class="add_account"><a href="Add_category.jsp">+ Add Category</a></span>
                    </td>
                </form>
            </tr>
            <tr>
            ...
            <tbody id="categorys">
                 <%
                     categorys_management tb = new categorys_management();
